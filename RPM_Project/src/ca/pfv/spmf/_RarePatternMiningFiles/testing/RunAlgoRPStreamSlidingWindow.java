...
import ca.pfv.spmf._RarePatternMiningFiles.implementations.AlgoRPStreamSlidingWindow;
import ca.pfv.spmf.patterns.itemset_array_integers_with_count.Itemsets;


public class RunAlgoRPStreamSlidingWindow {
	public static void main(String[] arg) throws FileNotFoundException, IOException{
		...
		AlgoRPStreamSlidingWindow algo = new AlgoRPStreamSlidingWindow();
